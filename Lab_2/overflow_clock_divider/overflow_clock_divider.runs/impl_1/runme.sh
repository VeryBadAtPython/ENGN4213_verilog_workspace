...
HD_PWD='C:/Users/Jacob/Documents/Vivado_Projects/ENGN4213_verilog_workspace/Lab_2/overflow_clock_divider/overflow_clock_divider.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log overflowClockDivider.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source overflowClockDivider.tcl -notrace
