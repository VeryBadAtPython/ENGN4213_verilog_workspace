...
HD_PWD='C:/Users/Jacob/Documents/Vivado_Projects/ENGN4213_verilog_workspace/Lab_2/overflow_clock_divider/overflow_clock_divider.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log overflowClockDivider.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source overflowClockDivider.tcl
