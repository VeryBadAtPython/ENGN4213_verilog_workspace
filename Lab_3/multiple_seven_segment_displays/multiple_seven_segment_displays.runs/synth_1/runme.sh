...
HD_PWD='C:/Users/Jacob/Documents/Vivado_Projects/ENGN4213_verilog_workspace/Lab_3/multiple_seven_segment_displays/multiple_seven_segment_displays.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multipleSevenSegmentDisplays_TOP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multipleSevenSegmentDisplays_TOP.tcl
