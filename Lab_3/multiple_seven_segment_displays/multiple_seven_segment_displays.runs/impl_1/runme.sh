...
HD_PWD='C:/Users/Jacob/Documents/Vivado_Projects/ENGN4213_verilog_workspace/Lab_3/multiple_seven_segment_displays/multiple_seven_segment_displays.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multipleSevenSegmentDisplays_TOP.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multipleSevenSegmentDisplays_TOP.tcl -notrace
