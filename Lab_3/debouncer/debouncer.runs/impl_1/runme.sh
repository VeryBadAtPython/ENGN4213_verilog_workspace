...
HD_PWD='C:/Users/Jacob/Documents/Vivado_Projects/ENGN4213_verilog_workspace/Lab_3/debouncer/debouncer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log debouncetest_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source debouncetest_top.tcl -notrace
