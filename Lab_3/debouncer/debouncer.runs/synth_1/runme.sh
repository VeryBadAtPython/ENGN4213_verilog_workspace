...
HD_PWD='C:/Users/Jacob/Documents/Vivado_Projects/ENGN4213_verilog_workspace/Lab_3/debouncer/debouncer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log debouncetest_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source debouncetest_top.tcl
