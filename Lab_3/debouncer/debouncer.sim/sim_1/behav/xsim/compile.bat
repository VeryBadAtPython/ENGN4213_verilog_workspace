...
REM
REM Generated by Vivado on Tue Mar 17 11:56:07 +1100 2026
...
echo "xvlog --incr --relax -prj debouncetest_top_vlog.prj"
call xvlog  --incr --relax -prj debouncetest_top_vlog.prj -log xvlog.log
