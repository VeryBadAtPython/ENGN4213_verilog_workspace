...
HD_PWD='C:/Users/Jacob/Documents/Vivado_Projects/ENGN4213_verilog_workspace/Lab_3/single_seven_segment_display/single_seven_segment_display.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log singleSevenSegmentDisplay_TOP.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source singleSevenSegmentDisplay_TOP.tcl -notrace
