...
HD_PWD='C:/Users/Jacob/Documents/Vivado_Projects/ENGN4213_verilog_workspace/Lab_3/single_seven_segment_display/single_seven_segment_display.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log singleSevenSegmentDisplay_TOP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source singleSevenSegmentDisplay_TOP.tcl
