...
HD_PWD='C:/Users/Jacob/Documents/Vivado_Projects/ENGN4213_verilog_workspace/Lab_4/comms_proj/comms_proj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log humanreceiver_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source humanreceiver_top.tcl -notrace
