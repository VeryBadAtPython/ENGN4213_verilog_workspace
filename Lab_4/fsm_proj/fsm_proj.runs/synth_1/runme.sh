...
HD_PWD='C:/Users/Jacob/Documents/Vivado_Projects/ENGN4213_verilog_workspace/Lab_4/fsm_proj/fsm_proj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MicrowaveFSM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MicrowaveFSM.tcl
