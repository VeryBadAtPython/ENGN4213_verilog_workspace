...
HD_PWD='C:/Users/Jacob/Documents/Vivado_Projects/ENGN4213_verilog_workspace/Lab_4/fsm_proj/fsm_proj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MicrowaveFSM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MicrowaveFSM.tcl -notrace
