...
HD_PWD='C:/Users/Jacob/Documents/Vivado_Projects/ENGN4213_verilog_workspace/Lab_4/comms_proj/comms_proj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log humanreceiver_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source humanreceiver_top.tcl
